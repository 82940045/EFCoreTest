    ...
    public class Program
    {
        ...
        public static void Run_Poll(string brokerList, List<string> topics)
        {
            var config = new Dictionary<string, object>
            {
                ...
                { "group.id", "CID_alikafka_dev_usertrack" },
        ...
        {
            //consumer: CID_alikafka_dev_usertrack   topic：alikafka-dev_usertrack

            args = "poll|172.16.20.232:9092,172.16.20.233:9092,172.16.20.234:9092|alikafka-dev_usertrack".Split('|');
            if (args.Length < 3)
            {
                PrintUsage();
                return;
